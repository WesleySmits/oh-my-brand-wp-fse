...
import { TextControl, Placeholder, PanelBody, RangeControl, ToggleControl } from '@wordpress/components';
			...
			<InspectorControls>
				<PanelBody title={__('Video Settings', 'theme-oh-my-brand')} initialOpen={true}>
					...
					<ToggleControl
						...
						help={__('Load the video only when visible on screen.', 'theme-oh-my-brand')}
						checked={lazyLoad}
