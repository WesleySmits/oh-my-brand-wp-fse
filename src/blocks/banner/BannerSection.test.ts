...
describe('BannerSection', () => {
	...
	describe('observed attributes', () => {
		it('should observe image-position attribute', () => {
			expect(BannerSection.observedAttributes).toContain('image-position');
		});

		it('should observe image-size attribute', () => {
			expect(BannerSection.observedAttributes).toContain('image-size');
		});

		it('should observe vertical-align attribute', () => {
			expect(BannerSection.observedAttributes).toContain('vertical-align');
		});

		it('should observe mobile-stack attribute', () => {
			expect(BannerSection.observedAttributes).toContain('mobile-stack');
		});
	...
	describe('mobile stack order', () => {
		it('should accept image-first stack order', () => {
			...
			expect(element.getAttribute('mobile-stack')).toBe('image-first');
		});

		it('should accept content-first stack order', () => {
			element.setAttribute('mobile-stack', 'content-first');
			expect(element.getAttribute('mobile-stack')).toBe('content-first');
		});
	});
