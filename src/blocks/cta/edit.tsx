 ...
 */
export default function Edit({ attributes, setAttributes }: BlockEditProps<CTAAttributes>): JSX.Element {
	const { heading, headingLevel, content, contentAlignment, primaryButton, secondaryButton } = attributes;
	...
	return (
		<>
			<InspectorControls>
				{/* Heading Settings */}
				<PanelBody title={__('Heading Settings', 'theme-oh-my-brand')} initialOpen={true}>
			...
			<div {...blockProps}>
				<div className="wp-block-theme-oh-my-brand-cta__content">
					...
					<RichText
						...
						placeholder={__('Add supporting text…', 'theme-oh-my-brand')}
					/>
