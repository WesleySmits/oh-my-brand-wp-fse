...
import { Button, PanelBody, Placeholder, RangeControl, ToggleControl } from '@wordpress/components';
			...
			<div {...blockProps}>
				{!hasImages ? (
					<Placeholder
						...
						instructions={__('Select images to display in the carousel.', 'theme-oh-my-brand')}
					>
						<MediaUploadCheck>
							<MediaUpload
								onSelect={(media) => {
